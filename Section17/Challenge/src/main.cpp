...
{
    //make_unique
    std::unique_ptr<std::vector<std::shared_ptr<Test>>> MakeUniquePtr = std::make_unique<std::vector<std::shared_ptr<Test>>>();
...
void fill(std::vector<std::shared_ptr<Test>> &vec, int num)
{
    ...
    for(int i = 0;i<size;i++)
    {
        ...
        int _tmpcin{0};
        std::cin >> _tmpcin;
        std::shared_ptr<Test> t = std::make_shared<Test>(_tmpcin);
        vec.push_back(t);
    }
    ...
    //     int _tmpcin{0};
    //     std::cin >> _tmpcin;
    //     vec.push_back(std::make_shared<Test>(_tmpcin));
    // }
}

void display(const std::vector<std::shared_ptr<Test>>&vec)
{
    // std::cout<<"Displaying cector data"<<std::endl;
    // std::cout<<"======================"<<std::endl;
    // for(const auto v : vec)
    // {
    //     std::cout<< v.get()->get_data()<<std::endl;
    // }
    // std::cout<<"======================"<<std::endl;
