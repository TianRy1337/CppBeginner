...
void test2()
{
    ...
    // Test whether triangle1 and triange3 are equivalent
...
// Similar to the lanbda "bonus" we defined earlier which awarded
// bonus points to test scores, the trans form function applies whatever
// operation is defined within the passed lambda to each element of the sequence.
// in thiscase, each test score is increased by 5 points
void test3()
{
    std::cout << "\n Test3 ===========================" << std::endl;
...
void test5()
{
    ...
    Person person1{"Berry", 34};
    Person person2{"Ryan", 24};
    Person person3("Jack", 44);
